...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_About_Me_t, stringdata) + ofs \
...
const QMetaObject About_Me::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_About_Me.data,
      qt_meta_data_About_Me,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_About_Me.stringdata))
