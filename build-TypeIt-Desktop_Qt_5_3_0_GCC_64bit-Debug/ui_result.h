...
""));
    ...
    void retranslateUi(QDialog *Result)
    {
        ...
        textBrowser->setPlaceholderText(QApplication::translate("Result", "YOUR RESULT APPEARS HERE..CLICK \"RESULT\"", 0));
        pushButton_2->setText(QString());
        pushButton_3->setText(QApplication::translate("Result", "Give Up", 0));
        pushButton->setText(QApplication::translate("Result", "Test Again", 0));
    } // retranslateUi
